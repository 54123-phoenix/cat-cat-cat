...
export default function FeedItem({ sighting }) {
  const content = (
    <div className="bg-white rounded-xl border border-gray-100 px-4 py-3 flex gap-3 active:bg-orange-50 transition-colors animate-fadeup">
      ...
      <div className="min-w-0 flex-1">
        <div className="flex items-start justify-between gap-2">
          ...
          <span className="text-[10px] text-gray-400 shrink-0">{formatTime(sighting.created_at)}</span>
        </div>
